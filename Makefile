...
#
# Generated on 2026-08-21T20:28:04Z by kres 063d4c2.
...
TARGETS += tools-curl
TARGETS += tools-dtc
TARGETS += tools-elfutils
TARGETS += tools-gcc-runtime
TARGETS += tools-gmp
TARGETS += tools-gnutls
TARGETS += tools-libbpf
TARGETS += tools-libffi
TARGETS += tools-libtasn1
TARGETS += tools-libunistring
TARGETS += tools-musl-fts
TARGETS += tools-musl-obstack
TARGETS += tools-nettle
